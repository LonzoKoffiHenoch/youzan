<x-splade-toggle>
    <div class="max-w-8xl flex bg-white">

        <div class=" border-b border-gray-100 flex-1">
            <!-- Primary Navigation Menu -->
            <div class="max-w-8xl px-8 sm:px-6 lg:px-8">
                        ...
                        <x-dropdown placement="bottom-end">
                            <x-slot name="trigger">
                                <button
                                    ...
                                    <span class="rounded-full bg-black w-8 h-8 "></span>
