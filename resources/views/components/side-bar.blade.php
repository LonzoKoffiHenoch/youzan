<div class="bg-blue-600 h-screen py-8 w-[265px] px-2">
    <!-- Logo -->
    ...
    <nav class="space-y-1 px-2 mt-5">
        ...
        <a href="{{ route('administrative.index') }}"
           class="bg-indigo-800 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
            ...
            <svg class="mr-4 h-6 w-6 flex-shrink-0 text-indigo-300" xmlns="http://www.w3.org/2000/svg"
